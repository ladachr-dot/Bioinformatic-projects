...
В этом репозитории собраны практические задачи и проекты, демонстрирующие применение Python в области биоинформатики и анализа данных.

---

### 📌 Обо мне

Я изучаю биотехнологии (направление биофармацевтика) в университете ИТМО. Я использую этот репозиторий для отработки навыков программирования на реальных биологических данных.
